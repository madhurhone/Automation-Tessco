...
public class Orderplacementwithpurchaseplan {
	WebDriver driver;
	...
	public void savedquotes(String username, String password, String Transmitfrequency, String Receivefrequency, String Search) throws InterruptedException, IOException{
		...
		Files.copy(screen1, new File(imagesavepath+"Homepage13.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 1. Launch the home page");
		Reporter.log("<br><br><img src='"+imagereportpath+"Homepage13.png' width='800' height='400'>");		
		...
		//verification of home page
				...
				Files.copy(screen2, new File(imagesavepath+"userloggedin13.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 2. user logged in successfully.");
				Reporter.log("<br><br><img src='"+imagereportpath+"userloggedin13.png' width='800' height='400'>");		
		...
		//Cable products category page link	
		Thread.sleep(2000);
		boolean plp = driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[1]/div/div[2]/div/div[3]/div/a/img")).isEnabled();
		assertTrue(plp);
		
		boolean plp1 = driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[1]/div/div[2]/div/div[3]/div/a/img")).isDisplayed();
		assertTrue(plp1);
		
		driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[1]/div/div[2]/div/div[3]/div/a/img")).click();
		
		// take screenshot
				TakesScreenshot screenshot3 = (TakesScreenshot) driver;
				File screen3 = screenshot3.getScreenshotAs(OutputType.FILE);
				Files.copy(screen3, new File(imagesavepath+"filtersplp13.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 3.User navigated to PLP page.");
				Reporter.log("<br><br><img src='"+imagereportpath+"filtersplp13.png' width='800' height='400'>");		
					
		//Add to cart button link 505817
		Thread.sleep(4000);
		driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[2]/div/div[1]/div/div/div[2]/li[3]/div/div[2]/div[5]/div/div[2]/form[1]/button")).click();
		...
		//confirmation radio button
			...
			// take screenshot
						...
						Files.copy(screen4, new File(imagesavepath+"frequencypopup13.png"));
								
						//Attached screenshot in Testing report
						Reporter.log("<br><br> 4.User able to give frequrncy values for selected product.");
						Reporter.log("<br><br><img src='"+imagereportpath+"frequencypopup13.png' width='800' height='400'>");		
		...
		Files.copy(screen5, new File(imagesavepath+"searchplp13.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 5.User able to search product using search bar.");
		Reporter.log("<br><br><img src='"+imagereportpath+"searchplp13.png' width='800' height='400'>");		
		...
		// take screenshot
				...
				Files.copy(screen6, new File(imagesavepath+"cartpage13.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 6.User should be able to navigate to cart page.");
				Reporter.log("<br><br><img src='"+imagereportpath+"cartpage13.png' width='800' height='400'>");		
				
		//purchase plan selection
				Thread.sleep(2000);
				driver.findElement(By.xpath("/html/body/main/div[2]/div[3]/div/div/div[3]/div[2]/div/ul/fieldset/li/ul/li[1]/form/div[1]/button")).click();
				Thread.sleep(2000);
				driver.findElement(By.xpath("/html/body/main/div[2]/div[3]/div/div/div[3]/div[2]/div/ul/fieldset/li/ul/li[1]/form/div[1]/ul/li[6]/a")).click();

				// take screenshot
						TakesScreenshot screenshot10 = (TakesScreenshot) driver;
						File screen10 = screenshot10.getScreenshotAs(OutputType.FILE);
						Files.copy(screen10, new File(imagesavepath+"purchaseplan13.png"));
								
						//Attached screenshot in Testing report
						Reporter.log("<br><br> 7.User should be able to navigate to cart page.");
						Reporter.log("<br><br><img src='"+imagereportpath+"purchaseplan13.png' width='800' height='400'>");		
		...
		Files.copy(screen7, new File(imagesavepath+"checkoutpage13.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 8.User should be able to enter delivery instructions field.");
		Reporter.log("<br><br><img src='"+imagereportpath+"checkoutpage13.png' width='800' height='400'>");		
		...
		Files.copy(screen8, new File(imagesavepath+"shipitems13.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 9.User should be able to select ship all items check box.");
		Reporter.log("<br><br><img src='"+imagereportpath+"shipitems13.png' width='800' height='400'>");		
		...
		Files.copy(screen9, new File(imagesavepath+"shipitems13.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 10.User should be able to enter P.O.Number and Credit card details radio button.");
		Reporter.log("<br><br><img src='"+imagereportpath+"shipitems13.png' width='800' height='400'>");		
		...
		// take screenshot
				...
				Files.copy(screen11, new File(imagesavepath+"placeorder13.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 11.User should be able to place order successfully using saved address and credit card Payment.");
				Reporter.log("<br><br><img src='"+imagereportpath+"placeorder13.png' width='800' height='400'>");		
				...
				//scroll bar
						...
						Files.copy(screen12, new File(imagesavepath+"APplaceorder13.png"));
								
						//Attached screenshot in Testing report
						Reporter.log("<br><br> 12.User should be able to place order successfully using saved address and credit card Payment.");
						Reporter.log("<br><br><img src='"+imagereportpath+"APplaceorder13.png' width='800' height='400'>");		
