...
public class OrderplacementwithAccountpayment {
	WebDriver driver;
	...
	public void savedquotess(String username, String password, String Transmitfrequency, String Receivefrequency, String Search) throws InterruptedException, IOException{
		
		// take screenshot
				TakesScreenshot screenshot1 = (TakesScreenshot) driver;
				File screen1 = screenshot1.getScreenshotAs(OutputType.FILE);
				Files.copy(screen1, new File(imagesavepath+"Homepage10.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 1. Launch the home page");
				Reporter.log("<br><br><img src='"+imagereportpath+"Homepage10.png' width='800' height='400'>");		
		...
		//verification of home page
				...
				Files.copy(screen2, new File(imagesavepath+"userloggedin10.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 2. user logged in successfully.");
				Reporter.log("<br><br><img src='"+imagereportpath+"userloggedin10.png' width='800' height='400'>");		
		...
		//Antennas category page link	
		Thread.sleep(2000);
		boolean plp = driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[1]/div/div[2]/div/div[1]/div/a/img")).isEnabled();
		assertTrue(plp);
		
		boolean plp1 = driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[1]/div/div[2]/div/div[1]/div/a/img")).isDisplayed();
		assertTrue(plp1);
		
		driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[1]/div/div[2]/div/div[1]/div/a/img")).click();
		
		// take screenshot
		TakesScreenshot screenshot3 = (TakesScreenshot) driver;
		File screen3 = screenshot3.getScreenshotAs(OutputType.FILE);
		Files.copy(screen3, new File(imagesavepath+"filtersplp10.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 3.User navigated to PLP page.");
		Reporter.log("<br><br><img src='"+imagereportpath+"filtersplp10.png' width='800' height='400'>");		
				
		//Add to cart button link 576792
		Thread.sleep(4000);
		driver.findElement(By.xpath("/html/body/main/div[2]/div[4]/div[2]/div/div[1]/div/div/div[2]/li[4]/div/div[2]/div[5]/div/div[2]/form[1]/button")).click();
		...
		//confirmation radio button
			...
			Files.copy(screen4, new File(imagesavepath+"frequencypopup10.png"));
					
			//Attached screenshot in Testing report
			Reporter.log("<br><br> 4.User able to give frequrncy values for selected product.");
			Reporter.log("<br><br><img src='"+imagereportpath+"frequencypopup10.png' width='800' height='400'>");		
		...
		// take screenshot
					...
					Files.copy(screen5, new File(imagesavepath+"searchplp10.png"));
							
					//Attached screenshot in Testing report
					Reporter.log("<br><br> 5.User able to search product using search bar.");
					Reporter.log("<br><br><img src='"+imagereportpath+"searchplp10.png' width='800' height='400'>");		
		...
		Files.copy(screen6, new File(imagesavepath+"cartpage10.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 6.User should be able to navigate to cart page.");
		Reporter.log("<br><br><img src='"+imagereportpath+"cartpage10.png' width='800' height='400'>");		
		...
		driver.findElement(By.xpath("/html/body/main/div[2]/div[2]/div[2]/div/div[1]/div[3]/fieldset/div/form/div[1]/div[2]/div[3]/div/div[2]/div/label/span/span[1]")).click();
		Thread.sleep(5000);
		
		// take screenshot
				TakesScreenshot screenshot7 = (TakesScreenshot) driver;
				File screen7 = screenshot7.getScreenshotAs(OutputType.FILE);
				Files.copy(screen7, new File(imagesavepath+"checkoutpage10.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 7.User should be able to select saved addresses.");
				Reporter.log("<br><br><img src='"+imagereportpath+"checkoutpage10.png' width='800' height='400'>");		
		...
		Files.copy(screen8, new File(imagesavepath+"shipitems10.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 8.User should be able to select ship all items check box.");
		Reporter.log("<br><br><img src='"+imagereportpath+"shipitems10.png' width='800' height='400'>");		
		...
		// take screenshot
				...
				Files.copy(screen9, new File(imagesavepath+"shipitems10.png"));
		...
		Files.copy(screen10, new File(imagesavepath+"placeorder10.png"));
				
		//Attached screenshot in Testing report
		Reporter.log("<br><br> 9.User should be able to place order successfully using saved address and Account Payment.");
		Reporter.log("<br><br><img src='"+imagereportpath+"placeorder10.png' width='800' height='400'>");		
		...
		//scroll bar
				...
				Files.copy(screen11, new File(imagesavepath+"APplaceorder10.png"));
						
				//Attached screenshot in Testing report
				Reporter.log("<br><br> 9.User should be able to place order successfully using saved address and Account Payment.");
				Reporter.log("<br><br><img src='"+imagereportpath+"APplaceorder10.png' width='800' height='400'>");		
