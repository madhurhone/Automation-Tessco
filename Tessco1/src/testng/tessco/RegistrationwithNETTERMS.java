...
public class RegistrationwithNETTERMS {
	WebDriver driver;
	...
	String imagesavepath = "C:\\Users\\MRAYAVAR\\WS_1805\\Tessco1\\test-output\\Output-screenshots\\";
		...
		public void registration(String username, String password, String companylegalentityname, String addressline1, String addressline2, String city, String postalCode, String Emailaddresstoreceiveinvoices, String firstname, String lastname, String email, String phone, String Rusername, String Rpassword, String Rconfirmpassword, String contactfirstname, String contactlastname) throws InterruptedException, IOException {
			...
			Files.copy(screen1, new File(imagesavepath+"Homepage3.png"));
									
			//Attached screenshot in Testing report
			Reporter.log("<br><br> 1. Launch the home page");
			Reporter.log("<br><br><img src='"+imagereportpath+"Homepage3.png' width='800' height='400'>");		
			...
			Files.copy(screen, new File(imagesavepath+"Logindetails3.png"));
					
			//Attached screenshot in Testing report
			Reporter.log("<br><br><img src='"+imagereportpath+"Logindetails3.png' width='800' height='400'");
			...
			Files.copy(screen3, new File(imagesavepath+"Registration3.png"));
					
			//Attached screenshot in Testing report
			Reporter.log("<br><br><img src='"+imagereportpath+"Registration3.png' width='800' height='400'");
			...
			Files.copy(screen4, new File(imagesavepath+"ClickRegister3.png"));
					
			//Attached screenshot in Testing report
			Reporter.log("<br><br><img src='"+imagereportpath+"ClickRegister3.png' width='800' height='400'");
			...
			Files.copy(screen5, new File(imagesavepath+"Addressline3.png"));
					
			//Attached screenshot in Testing report
			Reporter.log("<br><br><img src='"+imagereportpath+"Addressline3.png' width='800' height='400'");
			...
			driver.findElement(By.xpath("//*[@id=\"NTAccountPayableContactFirstName\"]")).sendKeys(contactfirstname);
					...
					Files.copy(screen6, new File(imagesavepath+"apphone3.png"));
					
					//Attached screenshot in Testing report
					Reporter.log("<br><br><img src='"+imagereportpath+"apphone3.png' width='800' height='400'");
					...
					Files.copy(screen7, new File(imagesavepath+"cnfpwd3.png"));
					
					//Attached screenshot in Testing report
					Reporter.log("<br><br><img src='"+imagereportpath+"cnfpwd3.png' width='800' height='400'");
					...
					Files.copy(screen8, new File(imagesavepath+"register6.png"));
					
					//Attached screenshot in Testing report
					Reporter.log("<br><br><img src='"+imagereportpath+"register6.png' width='800' height='400'");
